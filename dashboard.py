...
from utils.c_models import random_forest, logistic_regression, gradient_boosting_sklearn
...
if not st.sidebar.checkbox("Hide", True, key='9'):
    ...
    if select3 == 'Logistic Regression':
        ...
        st.write('Accuracy Score: ', 0.791618)
    ...
    if select3 == 'Gradient Boosting':
        ...
        st.write('Accuracy Score: ', 0.844393)
